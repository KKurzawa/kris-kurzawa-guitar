    ...
    return (
        <main className='mainHome flex flex-col'>
            <article className='flex flex-col items-center'>
                ...
                <button onClick={() => setTimeout(() => window.open('https://www.amazon.com/Sly-Kris-Kurzawa/dp/B01AXGA21W', '_blank'), 500)}><img src={Sly} className='sly w-[23rem] md:w-[35rem] lg:w-[50rem] h-auto mt-1 mb-4' /></button>
                {/* large */}
                ...
                <article className='lg:hidden flex flex-col py-5'>
                    <header className='text-center pb-1 text-3xl font-bold'>{singleVideoTitle}</header>
                    <iframe className='singleVideo md:hidden' width="350" height="196.875" src={singleVideoLink} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen loading='lazy'></iframe>
